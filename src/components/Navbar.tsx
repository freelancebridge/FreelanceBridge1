          ...
          <div className="flex items-center space-x-4">
            ...
            {status === 'loading' ? (
              ...
              <div className="flex items-center space-x-6">
                <Link href="/dashboard" className="text-gray-700 hover:text-purple-700 text-sm font-bold transition-colors">
                  Dashboard
                </Link>
                <Link href="/notifications" className="relative text-gray-500 hover:text-purple-600 transition-colors">
                ...
                <div className="flex flex-col sm:flex-row items-center space-x-0 sm:space-x-3 border-l border-gray-200 pl-6">
                  <span className="text-sm font-bold text-gray-900 truncate max-w-[100px]">{session.user.name}</span>
                  ...
                  <button onClick={() => signOut()} className="text-gray-500 hover:text-red-600 text-sm font-medium transition-colors ml-4 sm:ml-4 mt-2 sm:mt-0">
                    Log Out
                  </button>
                </div>
              </div>
